...
public abstract class Entity implements ICommandListener, KeyedObject
{
    ...
    public Entity(final World world) {
        ...
        this.aH = (Set<String>)Sets.newHashSet();
    ...
    private boolean paperNetherCheck() {
        return this.world.paperConfig.netherVoidTopDamage && this.world.getWorld().getEnvironment() == org.bukkit.World.Environment.NETHER && this.locY >= 128.0;
    }
        ...
        if (!this.fireProof) {
            ...
            if (this instanceof EntityLiving) {
                if (this.fireTicks <= 0) {
                    ...
                    final EntityCombustEvent combustEvent = (EntityCombustEvent)new EntityCombustByBlockEvent(damager, damagee, 15);
    ...
    public void move(final EnumMoveType enummovetype, double d0, double d1, double d2) {
        if (this.noclip) {
            ...
            if ((enummovetype == EnumMoveType.SELF || enummovetype == EnumMoveType.PLAYER) && this.onGround && this.isSneaking() && this instanceof EntityHuman) {
                ...
                while (d0 != 0.0 && this.world.getCubes(this, this.getBoundingBox().d(d0, (double)(-this.P), 0.0)).isEmpty()) {
                    if (d0 < 0.05 && d0 >= -0.05) {
                        d0 = 0.0;
                    }
                    else if (d0 > 0.0) {
                ...
                while (d2 != 0.0 && this.world.getCubes(this, this.getBoundingBox().d(0.0, (double)(-this.P), d2)).isEmpty()) {
                    if (d2 < 0.05 && d2 >= -0.05) {
                        d2 = 0.0;
                    }
                    else if (d2 > 0.0) {
                ...
                while (d0 != 0.0 && d2 != 0.0 && this.world.getCubes(this, this.getBoundingBox().d(d0, (double)(-this.P), d2)).isEmpty()) {
                    if (d0 < 0.05 && d0 >= -0.05) {
                        d0 = 0.0;
                    }
                    else if (d0 > 0.0) {
            ...
            if (this.P > 0.0f && flag && (d7 != d0 || d9 != d2)) {
                ...
                d1 = this.P;
                final List list2 = this.world.getCubes(this, this.getBoundingBox().b(d7, d1, d9));
            ...
            if (this.playStepSound() && (!this.onGround || !this.isSneaking() || !(this instanceof EntityHuman)) && !this.isPassenger()) {
                ...
                if (this.K > this.ax && iblockdata.getMaterial() != Material.AIR) {
                    ...
                    if (this.isInWater()) {
                        ...
                        float f2 = MathHelper.sqrt(entity.motX * entity.motX * 0.20000000298023224 + entity.motY * entity.motY + entity.motZ * entity.motZ * 0.20000000298023224) * f;
                        if (f2 > 1.0f) {
                            f2 = 1.0f;
                        }
            ...
            if (this.world.e(this.getBoundingBox().shrink(0.001))) {
                ...
                if (!flag2) {
                    ++this.fireTicks;
                    if (this.fireTicks == 0) {
                        final EntityCombustEvent event2 = (EntityCombustEvent)new EntityCombustByBlockEvent((Block)null, (org.bukkit.entity.Entity)this.getBukkitEntity(), 8);
    ...
    protected void checkBlockCollisions() {
        final AxisAlignedBB axisalignedbb = this.getBoundingBox();
        final BlockPosition.PooledBlockPosition blockposition_pooledblockposition = BlockPosition.PooledBlockPosition.d(axisalignedbb.a + 0.001, axisalignedbb.b + 0.001, axisalignedbb.c + 0.001);
        final BlockPosition.PooledBlockPosition blockposition_pooledblockposition2 = BlockPosition.PooledBlockPosition.d(axisalignedbb.d - 0.001, axisalignedbb.e - 0.001, axisalignedbb.f - 0.001);
        final BlockPosition.PooledBlockPosition blockposition_pooledblockposition3 = BlockPosition.PooledBlockPosition.s();
        if (this.world.areChunksLoadedBetween((BlockPosition)blockposition_pooledblockposition, (BlockPosition)blockposition_pooledblockposition2)) {
            for (int i = blockposition_pooledblockposition.getX(); i <= blockposition_pooledblockposition2.getX(); ++i) {
                for (int j = blockposition_pooledblockposition.getY(); j <= blockposition_pooledblockposition2.getY(); ++j) {
                    for (int k = blockposition_pooledblockposition.getZ(); k <= blockposition_pooledblockposition2.getZ(); ++k) {
                        blockposition_pooledblockposition3.f(i, j, k);
                        final IBlockData iblockdata = this.world.getType((BlockPosition)blockposition_pooledblockposition3);
                        try {
                            iblockdata.getBlock().a(this.world, (BlockPosition)blockposition_pooledblockposition3, iblockdata, this);
                            this.a(iblockdata);
                        }
                        catch (Throwable throwable) {
                            ...
                            CrashReportSystemDetails.a(crashreportsystemdetails, (BlockPosition)blockposition_pooledblockposition3, iblockdata);
                            throw new ReportedException(crashreport);
                        }
                    }
                }
    ...
    public boolean an() {
        ...
        final BlockPosition.PooledBlockPosition blockposition_pooledblockposition = BlockPosition.PooledBlockPosition.d(this.locX, this.locY, this.locZ);
        if (!this.world.isRainingAt((BlockPosition)blockposition_pooledblockposition) && !this.world.isRainingAt((BlockPosition)blockposition_pooledblockposition.e(this.locX, this.locY + this.length, this.locZ))) {
            blockposition_pooledblockposition.t();
            return false;
        }
        blockposition_pooledblockposition.t();
    ...
    public boolean doWaterMovement() {
        ...
        else if (this.world.a(this.getBoundingBox().grow(0.0, -0.4000000059604645, 0.0).shrink(0.001), Material.WATER, this)) {
    ...
    protected void ar() {
        ...
        for (int i = 0; i < 1.0f + this.width * 20.0f; ++i) {
            ...
            this.world.addParticle(EnumParticle.WATER_BUBBLE, this.locX + f4, f3 + 1.0f, this.locZ + f5, this.motX, this.motY - this.random.nextFloat() * 0.2f, this.motZ, new int[0]);
        }
        for (int i = 0; i < 1.0f + this.width * 20.0f; ++i) {
            final float f4 = (this.random.nextFloat() * 2.0f - 1.0f) * this.width;
            final float f5 = (this.random.nextFloat() * 2.0f - 1.0f) * this.width;
            this.world.addParticle(EnumParticle.WATER_SPLASH, this.locX + f4, f3 + 1.0f, this.locZ + f5, this.motX, this.motY, this.motZ, new int[0]);
        }
    }
    ...
    protected void at() {
        ...
        if (iblockdata.i() != EnumRenderType.INVISIBLE) {
            this.world.addParticle(EnumParticle.BLOCK_CRACK, this.locX + (this.random.nextFloat() - 0.5) * this.width, this.getBoundingBox().b + 0.1, this.locZ + (this.random.nextFloat() - 0.5) * this.width, -this.motX * 4.0, 1.5, -this.motZ * 4.0, net.minecraft.server.v1_12_R1.Block.getCombinedId(iblockdata));
        }
    }
    ...
    public boolean au() {
        return this.world.a(this.getBoundingBox().grow(-0.10000000149011612, -0.4000000059604645, -0.10000000149011612), Material.LAVA);
    }
    ...
    public float aw() {
        final BlockPosition.MutableBlockPosition blockposition_mutableblockposition = new BlockPosition.MutableBlockPosition(MathHelper.floor(this.locX), 0, MathHelper.floor(this.locZ));
            ...
            public NBTTagCompound a(final DataConverter dataconverter, final NBTTagCompound nbttagcompound, final int i) {
                if (nbttagcompound.hasKeyOfType("Passengers", 9)) {
                    ...
                    for (int j = 0; j < nbttaglist.size(); ++j) {
                        nbttaglist.a(j, (NBTBase)dataconverter.a((DataConverterType)DataConverterTypes.ENTITY, nbttaglist.get(j), i));
                    }
                }
    ...
    public NBTTagCompound save(final NBTTagCompound nbttagcompound) {
        try {
            ...
            if (this.origin != null) {
                nbttagcompound.set("Paper.Origin", (NBTBase)this.createList(this.origin.getX(), this.origin.getY(), this.origin.getZ()));
            }
    ...
    public void f(final NBTTagCompound nbttagcompound) {
        try {
            ...
            if (!originTag.isEmpty()) {
                this.origin = new Location((org.bukkit.World)this.world.getWorld(), originTag.getDoubleAt(0), originTag.getDoubleAt(1), originTag.getDoubleAt(2));
            }
    ...
    public Chunk getCurrentChunk() {
        ...
        return (chunk != null && chunk.isLoaded()) ? chunk : (this.isAddedToChunk() ? this.world.getChunkIfLoaded(this.getChunkX(), this.getChunkZ()) : null);
    }
    ...
    protected void o(final Entity entity) {
        ...
        Preconditions.checkState(!entity.passengers.contains(this), "Circular entity riding! %s %s", (Object)this, (Object)entity);
        final CraftEntity craft = (CraftEntity)entity.getBukkitEntity().getVehicle();
        final Entity orig = (craft == null) ? null : craft.getHandle();
        if (this.getBukkitEntity() instanceof Vehicle && entity.getBukkitEntity() instanceof LivingEntity && entity.world.isChunkLoaded((int)entity.locX >> 4, (int)entity.locZ >> 4, false)) {
            final VehicleEnterEvent event = new VehicleEnterEvent((Vehicle)this.getBukkitEntity(), (org.bukkit.entity.Entity)entity.getBukkitEntity());
        ...
        final EntityMountEvent event2 = new EntityMountEvent((org.bukkit.entity.Entity)entity.getBukkitEntity(), (org.bukkit.entity.Entity)this.getBukkitEntity());
    ...
    protected void p(final Entity entity) {
        ...
        if (this.getBukkitEntity() instanceof Vehicle && entity.getBukkitEntity() instanceof LivingEntity) {
            final VehicleExitEvent event = new VehicleExitEvent((Vehicle)this.getBukkitEntity(), (LivingEntity)entity.getBukkitEntity());
            Bukkit.getPluginManager().callEvent((Event)event);
            final CraftEntity craftn = (CraftEntity)entity.getBukkitEntity().getVehicle();
            final Entity n = (craftn == null) ? null : craftn.getHandle();
            if (event.isCancelled() || n != orig) {
        ...
        if (!new EntityDismountEvent((org.bukkit.entity.Entity)entity.getBukkitEntity(), (org.bukkit.entity.Entity)this.getBukkitEntity()).callEvent()) {
            return;
        }
    ...
    public void e(final BlockPosition blockposition) {
        if (this.portalCooldown > 0) {
            ...
            if (!this.world.isClientSide && !blockposition.equals((Object)this.an)) {
                ...
                final ShapeDetector.ShapeDetectorCollection shapedetector_shapedetectorcollection = Blocks.PORTAL.c(this.world, this.an);
                final double d0 = (shapedetector_shapedetectorcollection.getFacing().k() == EnumDirection.EnumAxis.X) ? shapedetector_shapedetectorcollection.a().getZ() : ((double)shapedetector_shapedetectorcollection.a().getX());
                double d2 = (shapedetector_shapedetectorcollection.getFacing().k() == EnumDirection.EnumAxis.X) ? this.locZ : this.locX;
                d2 = Math.abs(MathHelper.c(d2 - (double)((shapedetector_shapedetectorcollection.getFacing().e().c() == EnumDirection.EnumAxisDirection.NEGATIVE) ? 1 : 0), d0, d0 - shapedetector_shapedetectorcollection.d()));
                final double d3 = MathHelper.c(this.locY - 1.0, (double)shapedetector_shapedetectorcollection.a().getY(), (double)(shapedetector_shapedetectorcollection.a().getY() - shapedetector_shapedetectorcollection.e()));
    ...
    public void setAirTicks(final int i) {
        final EntityAirChangeEvent event = new EntityAirChangeEvent((org.bukkit.entity.Entity)this.getBukkitEntity(), i);
    ...
    public String toString() {
        return String.format("%s['%s'/%d, uuid='%s', l='%s', x=%.2f, y=%.2f, z=%.2f, cx=%d, cd=%d, tl=%d, v=%b, d=%b]", this.getClass().getSimpleName(), this.getName(), this.id, this.uniqueID.toString(), (this.world == null) ? "~NULL~" : this.world.getWorldData().getName(), this.locX, this.locY, this.locZ, this.getChunkX(), this.getChunkZ(), this.ticksLived, this.valid, this.dead);
    }
    ...
    public Entity b(final int i) {
        ...
        if (exitWorld != null) {
            if (blockposition != null) {
                exit = new Location((org.bukkit.World)exitWorld.getWorld(), (double)blockposition.getX(), (double)blockposition.getY(), (double)blockposition.getZ());
            }
            else {
                exit = minecraftserver.getPlayerList().calculateTarget(enter, (World)minecraftserver.getWorldServer(i));
            }
        }
        else {
            exit = null;
        ...
        final EntityPortalEvent event = new EntityPortalEvent((org.bukkit.entity.Entity)this.getBukkitEntity(), enter, exit, agent);
    ...
    public float a(final Explosion explosion, final World world, final BlockPosition blockposition, final IBlockData iblockdata) {
        return iblockdata.getBlock().a(this);
    }
    
    public boolean a(final Explosion explosion, final World world, final BlockPosition blockposition, final IBlockData iblockdata, final float f) {
        return true;
    }
    ...
    public IChatBaseComponent getScoreboardDisplayName() {
        final ChatComponentText chatcomponenttext = new ChatComponentText(ScoreboardTeam.getPlayerDisplayName(this.aY(), this.getName()));
    ...
    protected ChatHoverable bv() {
        ...
        return new ChatHoverable(ChatHoverable.EnumHoverAction.SHOW_ENTITY, (IChatBaseComponent)new ChatComponentText(nbttagcompound.toString()));
    }
    ...
    public void a(final CommandObjectiveExecutor.EnumCommandResult commandobjectiveexecutor_enumcommandresult, final int i) {
        if (this.world != null && !this.world.isClientSide) {
            this.aG.a(this.world.getMinecraftServer(), (ICommandListener)this, commandobjectiveexecutor_enumcommandresult, i);
        }
    }
