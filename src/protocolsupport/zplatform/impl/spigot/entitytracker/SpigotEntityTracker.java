...
public class SpigotEntityTracker extends EntityTracker {
	...
	@Override
	public synchronized void addEntity(Entity entity, int trackRange, int updateInterval, boolean updateVelocity) {
		// ~
		...
		try {
			...
			EntityTrackerEntry entitytrackerentry = createTrackerEntry(entity, trackRange, updateInterval,
					updateVelocity);
			...
			trackedEntities.get(entity.getId()).b()
	...
	protected EntityTrackerEntry createTrackerEntry(final Entity entity, int trackRange, int updateInterval,
			final boolean flag) {
	...
	static {
		...
		entityTrackMethods.setKnownPath(EntityFishingHook.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 5, true));
		entityTrackMethods.setKnownPath(EntityArrow.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 20, false));
		entityTrackMethods.setKnownPath(EntitySmallFireball.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 10, false));
		entityTrackMethods.setKnownPath(EntityFireball.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 10, true));
		entityTrackMethods.setKnownPath(EntitySnowball.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 10, true));
		entityTrackMethods.setKnownPath(EntityLlamaSpit.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 10, false));
		entityTrackMethods.setKnownPath(EntityEnderPearl.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 10, true));
		entityTrackMethods.setKnownPath(EntityEnderSignal.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 4, true));
		entityTrackMethods.setKnownPath(EntityEgg.class, (tracker, entity) -> tracker.addEntity(entity, 64, 10, true));
		entityTrackMethods.setKnownPath(EntityPotion.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 10, true));
		entityTrackMethods.setKnownPath(EntityThrownExpBottle.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 10, true));
		entityTrackMethods.setKnownPath(EntityFireworks.class,
				(tracker, entity) -> tracker.addEntity(entity, 64, 10, true));
		entityTrackMethods.setKnownPath(EntityItem.class, (tracker, entity) -> tracker.addEntity(entity, 64, 20, true));
		entityTrackMethods.setKnownPath(EntityMinecartAbstract.class,
				(tracker, entity) -> tracker.addEntity(entity, 80, 3, true));
		...
		entityTrackMethods.setKnownPath(EntityWither.class,
				(tracker, entity) -> tracker.addEntity(entity, 80, 3, false));
		entityTrackMethods.setKnownPath(EntityShulkerBullet.class,
				(tracker, entity) -> tracker.addEntity(entity, 80, 3, true));
		entityTrackMethods.setKnownPath(EntityBat.class, (tracker, entity) -> tracker.addEntity(entity, 80, 3, false));
		entityTrackMethods.setKnownPath(EntityEnderDragon.class,
				(tracker, entity) -> tracker.addEntity(entity, 160, 3, true));
		entityTrackMethods.setKnownPath(IAnimal.class, (tracker, entity) -> tracker.addEntity(entity, 80, 3, true));
		entityTrackMethods.setKnownPath(EntityTNTPrimed.class,
				(tracker, entity) -> tracker.addEntity(entity, 160, 10, true));
		entityTrackMethods.setKnownPath(EntityFallingBlock.class,
				(tracker, entity) -> tracker.addEntity(entity, 160, 20, true));
		entityTrackMethods.setKnownPath(EntityHanging.class,
				(tracker, entity) -> tracker.addEntity(entity, 160, Integer.MAX_VALUE, false));
		entityTrackMethods.setKnownPath(EntityArmorStand.class,
				(tracker, entity) -> tracker.addEntity(entity, 160, 3, true));
		entityTrackMethods.setKnownPath(EntityExperienceOrb.class,
				(tracker, entity) -> tracker.addEntity(entity, 160, 20, true));
		entityTrackMethods.setKnownPath(EntityAreaEffectCloud.class,
				(tracker, entity) -> tracker.addEntity(entity, 160, Integer.MAX_VALUE, true));
		entityTrackMethods.setKnownPath(EntityEnderCrystal.class,
				(tracker, entity) -> tracker.addEntity(entity, 256, Integer.MAX_VALUE, false));
		entityTrackMethods.setKnownPath(EntityEvokerFangs.class,
				(tracker, entity) -> tracker.addEntity(entity, 160, 2, false));
